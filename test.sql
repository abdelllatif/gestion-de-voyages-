...
SELECT 
    ...
    cliente.prenom,
    cliente.email,
    activite.titre AS activite_titre,
    activite.destination AS activite_destination,
...
('hanan', 'obaha', 'hananda@example.com', '4653456789', '654  Road', '1998-08-08');
...
DELETE FROM cliente WHERE id_client = 2;
